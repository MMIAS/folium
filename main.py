...
folium.Marker([-7.028385, 110.418130], popup='<i>Apotek Besen</i>').add_to(m)
folium.Marker([-7.029301, 110.418200], popup='<i>Indomaret Teuku Umar</i>').add_to(m)
folium.Marker([-7.028651, 110.420775], popup='<i>Gereja Kristen Jawa Jatingaleh</i>').add_to(m)
folium.Marker([-7.027309, 110.422097], popup='<i>Masjid At- Taqwa</i>').add_to(m)
folium.Marker([-7.026714, 110.423277], popup='<i>Asrama Brigif 5 , Kesatrian Jatingaleh</i>').add_to(m)
folium.Marker([-7.026924, 110.425704], popup='<i>Adi Bangun bangsa (De'Jamur)</i>').add_to(m)
folium.Marker([-7.027290, 110.424538], popup='<i>Sub Detasemen Zeni Bangunan 023/IV Zidam IV/Diponegoro</i>').add_to(m)
folium.Marker([-7.025882, 110.419823], popup='<i>SMK Antonius</i>').add_to(m)
folium.Marker([-7.027905, 110.418106], popup='<i>Noormans Hotel Semarang</i>').add_to(m)
folium.Marker([-7.026582, 110.418941], popup='<i>Agnes Sri Widayati Dr SpKK</i>').add_to(m)
folium.Marker([-6.980784, 110.457533], popup='<i>Puskesmas Tlogosari Kulon</i>').add_to(m)
folium.Marker([-6.969531, 110.430764], popup='<i>Bundaran Bubakan</i>').add_to(m)
folium.Marker([-6.969556, 110.431415], popup='<i>Kanca BRI Semarang Patimura</i>').add_to(m)
folium.Marker([-6.967796, 110.429119], popup='<i>Bara Alam Semesta</i>').add_to(m)
folium.Marker([-6.965896, 110.428825], popup='<i>UD.Sinar Semesta</i>').add_to(m)
folium.Marker([-6.966289, 110.428978], popup='<i>Ice Kristal Heng Sian</i>').add_to(m)
folium.Marker([-6.965250, 110.429450], popup='<i>Showroom Mobil Karya Zirang Utama</i>').add_to(m)
folium.Marker([-6.965782, 110.429769], popup='<i>PT.Alumindo Light Metal Industry</i>').add_to(m)
folium.Marker([-6.967226, 110.427447], popup='<i>Asrama Stailand</i>').add_to(m)
folium.Marker([-6.968758, 110.427064], popup='<i>Ikan Bakar Cianjur</i>').add_to(m)
